...
use UniversalPay\Payment\Helper\Payments;

class Payment extends \Magento\Payment\Model\Method\Cc
{
    const METHOD_CODE = 'universalpay';
    ...
    public function processPayments($payments, $payment, $token, $amount)
    {
        try {
            ...
            merchantNotificationUrl($urlInterface->getUrl('universalpay_checkout/index/response/orderid/' . $orderid))->
