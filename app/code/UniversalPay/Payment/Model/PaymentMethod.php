...
namespace UniversalPay\Payment\Model;


use UniversalPay\Payment\Model\Config\Source\Brand;
use UniversalPay\Payment\Helper\Helper;
use UniversalPay\Payment\Model\Config\Source\NewOrderPaymentActions;
...
class PaymentMethod extends \Magento\Payment\Model\Method\AbstractMethod implements GatewayInterface
{
    ...
    public function getCheckoutRedirectUrl()
    {
       ...
       if ($displayMode === DisplayMode::DISPLAY_MODE_IFRAME) {
           $redirectUrl = 'universalpay/hosted/iframe';
        } else {
            $redirectUrl = 'universalpay/hosted/redirect';
        }
